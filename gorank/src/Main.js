        ...
        <FadeInSection classes="skills-section" componentId="education">
          ...
          <div className="skills">
            ...
            >
              ...
              <p>
                Social Development Studies, Bachelor of Honours Arts and Business
              </p>
            </a>
            <div className="embedded-photo--container">
            ...
            <a
                ...
                href="https://dewanpublicschoolmeerut.org"
                target="_blank"
                rel="noopener noreferrer"
                className="skill skill--short"
            >
              <img src={dewan} alt="presentation" className="skill--image" />
              <h3 className="skill--title">
                Dewan Public School | 2002-2017
              </h3>
              <p>
                Humanities, CBSE
              </p>
